...
# Compute for h=10, class 11
h = 1000
N_h = 90 * h**2 - 12 * h + 1
amps11 = compute_amplitudes([11], 0, N_h)
holes11 = np.sum(amps11 == 0)
tau11 = holes11 / N_h

# For twins (joint holes with class 13)
amps13 = compute_amplitudes([13], 0, N_h)
joint_holes = np.sum((amps11 == 0) & (amps13 == 0))
tau_twins = joint_holes / N_h

print(f"Epoch h={h}, Span N={N_h}")
print(f"Class 11: Holes={holes11}, Transmittance={tau11:.4f}")
print(f"Twins (11&13): Holes={joint_holes}, Transmittance={tau_twins:.4f}")