...
2. Negative Space: Quadratic y(x) Curves + Raindrops from y + k*p
...
# ----------------------------------------------------------------------
# 4.  Negative Space Graph: Quadratic y(x) + Raindrops
# ----------------------------------------------------------------------
fig2 = plt.figure(figsize=(14, 11))
ax2 = fig2.add_subplot(111, projection='3d')

max_x = min(30, x_iters)  # Show more x for curve
curve_scale = 0.5  # Scale curve height
drop_step = -0.5
max_drops = 8
...
ax2.set_xlabel('X')
ax2.set_ylabel('Y')
ax2.set_zlabel('Negative Depth')
ax2.set_title(f"Negative Space: Quadratic y(x) + Raindrops – h={h}, epoch={epoch:,}")
