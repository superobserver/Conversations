...
def create_dual_view_animation(classes, num_epochs, show_traces_panel=True, show_red_intensity=True, output_file='dual_view_epoch_animation.gif'):
    ...
    red_overlay = ax_left.scatter([], [], color='red', alpha=0, s=25)  # will be updated
    ...
    def animate(frame):
        ...
        # Red entanglement overlay (toggleable)
    ...
    print(f"Red intensity overlay is {'ON' if show_red_intensity else 'OFF'}")
...
if __name__ == '__main__':
    ...
    show_red_intensity = False  # <--- Toggle here (True = show red entanglement, False = hide)
