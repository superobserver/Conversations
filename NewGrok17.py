...
print("Epoch:", epoch)
print("Marks:", sum(list17))
print("x iters:", int(new_limit.real))
print("Operators:", 24*int(new_limit.real))
#print("This is the number of markings", sum(list17), "for x =", int(new_limit.real))
...
#print(new)
print("Quantity Primes:", len(list17a))
