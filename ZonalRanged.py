...
# Example: Mark segment [0,1000] for h=10, class=[17]
h = 1000


classes = [7] 
print("A202110 Numbers k such that 90*k + 7 is prime.")
amp_segment = zonal_sieve_segment(h, classes, 0, 1000)
print(f"Segment amplitudes (first 100): {amp_segment[:100]}")
oeis_sequence = [i for i,x in enumerate(amp_segment) if x == 0]
print("This is the OEIS sequence.",oeis_sequence)
