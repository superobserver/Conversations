...
# ----------------------------------------------------------------------
# 5.  Ring Geometry Graph: Class 17 flat, Class 19 vertical, intersect at right angles
# ----------------------------------------------------------------------
fig3 = plt.figure(figsize=(16, 12))
ax3 = fig3.add_subplot(111, projection='3d')

# Class 17 holes (flat, horizontal plane)
...
# Class 19 holes (vertical, right angle intersection)
...
for n in class19_holes:
    ...
    yc = r * np.sin(th)
    zc = np.full_like(th, z_height)
    # Rotate to vertical (90° to horizontal)
    # Swap Y and Z for vertical plane
    ax3.plot(xc, zc, yc, color='red', linewidth=1.2, alpha=0.7)  # Swap Y and Z for vertical

ax3.set_xlabel('X')
ax3.set_ylabel('Y')
ax3.set_zlabel('Z = n')
ax3.set_title(f"Ring Geometry: Class 17 (flat) vs Class 19 (vertical) – h={h}, epoch={epoch:,}\nIntersect at right angles")
